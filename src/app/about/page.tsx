    ...
    <ThemedInnerPageLayout>
      ...
      <div className="container mx-auto px-4 py-16">
        <div className="max-w-5xl mx-auto">
          ...
          >
            <div>
              ...
              <div className="space-y-3">
                <div className="flex items-center space-x-3">
                  ...
                  <span className="text-slate-300">AI Voice Agents & Automation</span>
                </div>
                <div className="flex items-center space-x-3">
                  <div className="w-2 h-2 bg-cyan-400 rounded-full"></div>
                  <span className="text-slate-300">Custom Web Development</span>
                </div>
                <div className="flex items-center space-x-3">
                  <div className="w-2 h-2 bg-cyan-400 rounded-full"></div>
                  <span className="text-slate-300">SEO & Digital Marketing</span>
                </div>
                <div className="flex items-center space-x-3">
                  <div className="w-2 h-2 bg-cyan-400 rounded-full"></div>
                  <span className="text-slate-300">Business Analytics & Intelligence</span>
                </div>
              </div>
            </div>
            ...
            <div>
              ...
              <div className="bg-slate-800/50 rounded-lg p-6 border border-slate-700/50">
                <h4 className="text-lg font-semibold text-cyan-400 mb-3">Our Process</h4>
          ...
          >
            <h3 className="text-3xl font-bold text-white mb-8 text-center">Why Choose Agency Dev Works?</h3>
            <div className="grid md:grid-cols-3 gap-8">
              <div className="text-center">
                ...
                <h4 className="text-xl font-semibold text-white mb-2">Cutting-Edge Technology</h4>
                <p className="text-slate-300 text-sm">We stay ahead of the curve with the latest AI and automation technologies.</p>
              </div>
              ...
              <div className="text-center">
                ...
                <p className="text-slate-300 text-sm">Our track record speaks for itself with measurable business improvements.</p>
              </div>
              ...
              <div className="text-center">
                ...
                <p className="text-slate-300 text-sm">Our experienced professionals bring deep expertise across multiple domains.</p>
              </div>
            </div>
          </motion.div>
          ...
          >
            <h3 className="text-3xl font-bold text-white mb-12 text-center">Meet the Faces of ADW</h3>
            <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
              ...
              >
                ...
                <h4 className="text-xl font-bold text-white mb-2">Sajjad Alobaidi</h4>
                <p className="text-cyan-400 font-medium mb-3">Founder & CEO</p>
                <a 
                  href="https://www.linkedin.com/in/sajjad-alobaidi-66489930b/" 
                  target="_blank" 
                  rel="noopener noreferrer"
                  className="inline-flex items-center text-slate-400 hover:text-cyan-400 transition-colors duration-200"
                >
              ...
              >
                ...
                <h4 className="text-xl font-bold text-white mb-2">Mustafa Alzubaidi</h4>
                <p className="text-cyan-400 font-medium mb-3">VP, AI Development</p>
                <a 
              ...
              >
                ...
                <h4 className="text-xl font-bold text-white mb-2">Mario Hanna</h4>
                <p className="text-cyan-400 font-medium mb-3">VP, Digital Marketing Operations</p>
                <a 
              ...
              >
                ...
                <h4 className="text-xl font-bold text-white mb-2">Ali Hnyin</h4>
                <p className="text-cyan-400 font-medium mb-3">Director of Sales, Product Development</p>
                <a 
          ...
          >
            ...
            <a 
              href="/contact" 
              className="inline-block bg-gradient-to-r from-cyan-600 to-blue-600 hover:from-cyan-500 hover:to-blue-500 text-white font-bold py-4 px-8 rounded-lg text-lg transition-all duration-300 transform hover:scale-105 hover:shadow-lg hover:shadow-cyan-400/25"
            >
              Start Your Project
            </a>
          </motion.div>
